...
function addInput(divName){
     if (counter == limit)  {
          ...
          var bodyText = '<div id="child' + counter + '"><?php echo $divpositions;?><?php echo elgg_echo('resume:work:position'); echo elgg_echo('resume:*');?><input type="text" name="positions[]" value="" class="elgg-input-text" required/></div>';
          bodyText += '<?php echo $divwages;?><?php echo elgg_echo('resume:work:wage'); echo elgg_echo('resume:*');?><input type="text" name="wages[]" value="" class="elgg-input-text" required/></div>';
          bodyText += '<?php echo $divhours;?><?php echo elgg_echo('resume:work:hour'); echo elgg_echo('resume:*');?><input type="text" name="hours[]" value="" class="elgg-input-text" required/></div><br /><br /><div class="clearfloat"></div>';
          bodyText += '<?php echo $divweeks;?><?php echo elgg_echo('resume:work:weeks'); echo elgg_echo('resume:*');?><input type="text" name="weeks[]" value="" class="elgg-input-text" required/></div>';
 ...
 function addInput2(divName){
     if (counternew == limitnew)  {
          ...
          bodyText += '<div style="float:left; width:60%;margin-right:15px"><?php echo elgg_echo('resume:work:structure2');  echo elgg_echo('resume:*');?><br /><input type="text" name="structure2" value="" class="elgg-input-text"/ required></div>';
          bodyText += '<div style="float:left; width:30%;margin-top:5px"><?php echo elgg_echo('resume:work:country');  echo elgg_echo('resume:*');?><br /><select name="country" class="elgg-input-dropdown" required><?php echo $country_options; ?></select></div><div class="clearfloat"></div><br />'
    bodyText += '<div style="float:left; width:27%; margin-right:15px;"><?php echo elgg_echo('resume:work:currencycap');  echo elgg_echo('resume:*');?><select name="currenycap" class="elgg-input-dropdown" required><?php echo $currency_options; ?></select></div>'
    ...
    bodyText += '<div style="float:left; width:98%;"><?php echo elgg_echo('resume:workexperience:industryclass'); echo elgg_echo('resume:*');?><br /><select name="industryclass2" class="elgg-input-dropdown" required><?php echo $industryclass_options; ?></select></div>'
  ...
  <form action="<?php echo $vars['url']; ?>action/<?php echo $action ?>" method="post">
     ...
     <p>
      ...
      <?php echo elgg_view('input/dropdown', 
              array('name' => 'sector', 
                  ...
                  'value' => $vars['entity']->sector,'required' => true));
      ?>
    </p>
    ...
    <div class="clearfloat"></div><br />
      ...
      echo elgg_view('input/autocomplete', array('name' => 'structure', 'match_on' => 'companies', 
          'value' => $vars['entity']->structure, 'value_show' => $comshow,'required' => true)); ?>
        </div>
   ...
   <div style="float:left; width:98%;">
       ...
       echo  elgg_view("input/dropdown", array(
        ...
        "options_values"=> $industryclasses,'required' => true
        )
       );
       ?>
       <br />
   ...
   <div class="clearfloat"></div><br />
    ...
    echo elgg_echo('resume:work:wage'); 
      echo elgg_echo('resume:*');
       echo elgg_view('input/text', array('name' => "wages[]", 'value' => "",'required' => true));
       echo "</div>";
       echo $divhours;
    ...
    echo elgg_echo('resume:work:weeks'); 
      echo elgg_echo('resume:*');
       echo elgg_view('input/text', array('name' => "weeks[]", 'value' => "",'required' => true));
       echo "</div>";
       echo $divstarts;
    ...
    echo elgg_echo('resume:work:wage'); 
      echo elgg_echo('resume:*');
       echo elgg_view('input/text', array('name' => "wages[]", 'value' => $wages_array[$i],'required' => true));
       echo "</div>";
       echo $divhours;
    echo elgg_echo('resume:work:hour'); 
      echo elgg_echo('resume:*');
    ...
    echo elgg_echo('resume:work:weeks'); 
      echo elgg_echo('resume:*');
       echo elgg_view('input/text', array('name' => "weeks[]", 'value' => $weeks_array[$i],'required' => true));
       echo "</div>";
       echo $divstarts;
    echo elgg_echo('resume:work:starts');
       echo "<br />";
